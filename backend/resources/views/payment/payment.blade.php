...
@if($errors->has('error'))
    <div class="text-red-600 w-full border rounded px-3 py-2 mb-3">
        <p class="mt-2 text-sm text-red-600">{{  $errors->first('error') }}</p>
    </div>
@endif
                ...
                <div>
                    ...
                    <div id="paymentType" class="flex justify-around py-6">
                        <div class="flex items-center mx-2">
                            <input type="radio" id="boleto" @checked(old('billingType')=='BOLETO') name="billingType" value="BOLETO" class="mr-2">
                            <label for="boleto" class="text-gray-600">Boleto</label>
                        </div>
                        <div class="flex items-center mx-2">
                            <input type="radio" id="cartao" @checked(old('billingType')=='CREDIT_CARD') name="billingType" value="CREDIT_CARD" class="mr-2">
                            <label for="cartao" class="text-gray-600">Cartão</label>
                        </div>
                        <div class="flex items-center mx-2">
                            <input type="radio" id="pix" @checked(old('billingType')=='PIX') name="billingType" value="PIX" class="mr-2">
